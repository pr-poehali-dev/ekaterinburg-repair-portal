...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <a
        href="https://wa.me/73435555555?text=Здравствуйте!%20Хочу%20узнать%20о%20ремонте"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 animate-scale-in group"
